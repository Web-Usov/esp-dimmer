...
| `bring-up-log.md` | Журнал измерений issue #3: pinout, gates, soak, 4ch, БП |
...
| `schematics/component_pinouts.py` | Механический pinout PC817 DIP-4 и BC548 TO-92 |
| `assets/schematics/*.svg` | Сгенерированный артефакт для Markdown/GitHub (включая `component-pinouts.svg`) |
...
- Архитектура (`system_overview`, `four_channel_overview`, `component_pinouts`): `schemdraw.flow.Box`, **не** `elm.Ic` с именами выводов внутри — они наезжают на title.
