...
Для реальной нагрузки LED на PWM-выходе заменяется интерфейсом `PC817 -> BC548 -> DIM`. Логическая схема и механический pinout корпусов — отдельно; ножки не угадывать по DIP/TO-92 «на глаз»:

![Схема канала управления нагрузкой](assets/schematics/load-control-channel.svg)

![Pinout PC817 и BC548](assets/schematics/component-pinouts.svg)

Журнал сборки и измерений: [bring-up-log.md](bring-up-log.md).
