...
#if defined(ESP8266)
// Legacy / compatibility: NodeMCU ESP8266, 4 канала + master.
...
#elif defined(ESP32)
// Primary: ESP32-C3 SuperMini (проверено на железе).
// PWM: GPIO0/1/3/4. Кнопки не на USB D+/D− (18/19). Master на GPIO20.
